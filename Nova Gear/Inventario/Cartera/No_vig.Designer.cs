...
namespace Nova_Gear.Inventario.Cartera
{
	partial class No_vig
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Listado de Créditos NO vigentes";
			...
			this.Text = "Nova Gear [Inventario Cartera] - Listado de Créditos NO vigentes";
			this.Load += new System.EventHandler(this.No_vigLoad);
