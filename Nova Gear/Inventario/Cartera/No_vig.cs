...
{
	/// <summary>
	/// Description of No_vig.
	/// </summary>
	public partial class No_vig : Form
	{
		public No_vig()
		{
			//
		...
		void No_vigLoad(object sender, EventArgs e)
		{
			...
			no_vig=conex.consultar("SELECT reg_pat,credito,periodo,incidencia,fecha_incidencia,mov,fecha_mov,sector,ce,tipo_doc,fecha_alta,fecha_not,dias,importe,clase_doc,fecha_rale FROM cartera_inv_base WHERE status=\"NO_VIGENTE\"");
		...
		void Button2Click(object sender, EventArgs e)
		{
			...
			dialog_save.Title = "Guardar NO vigentes";//le damos un titulo a la ventana
